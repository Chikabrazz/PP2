...
while True:
    ...
    # To be run if collision occurs between Enemy and Enemy
    if pygame.sprite.groupcollide(enemies, enemies, False, False):
        # Handle the collision between two enemies here
        pass

    # Update SCORE if collision occurs between Player and Coin
